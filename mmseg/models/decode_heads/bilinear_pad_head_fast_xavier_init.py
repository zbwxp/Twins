...
class DynHead(nn.Module):
    def __init__(self,
        ...
        # nn.init.constant_(self.classifier[-1].weight, 1/num_out_channel)
...
class BilinearPADHead_fast_xavier_init(ASPPHead):
    ...
    def forward(self, inputs):
        ...
        # print("output_max:", output.max().item(), ",output_min:", output.min().item())
        # print("output_mean", output.mean().item(), ", output_std:", output.std().item())
